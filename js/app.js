...
/******/ 	"use strict";
  ...
  function initSliders() {
    if (document.querySelector('.slider-popular')) {
      new Swiper('.slider-popular__slider', {
        modules: [Navigation],
        observer: true,
        observeParents: true,
        slidesPerView: 1.1,
        ...
        // Кнопки "влево/вправо"
        navigation: {
          prevEl: '.popular .arrows__arrow_prev',
          nextEl: '.popular .arrows__arrow_next',
        },
        // Брейкпоинты
        breakpoints: {
          450: {
  ...
  function documentActions(e) {
    ...
    if (targetElement.closest(".actions-header__search")) {
      targetElement.closest(".actions-header__item").classList.toggle("_show-search");
    } else if (!targetElement.closest(".actions-header__item") && document.querySelector(".actions-header__search-form")) {
      document.querySelector(".actions-header__item").classList.remove("_show-search");
    }
  };
